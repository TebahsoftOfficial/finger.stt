(function (self) {
	...
	if (ENVIRONMENT_IS_NODE) {
		...
		if (typeof console !== 'undefined') {
			...
			if (!Module['print'])
				Module['print'] = TRY_USE_DUMP && typeof dump !== 'undefined' ? function (e) {
					dump(e);
				} : function (e) {
				};
		}
	...
	function setValue(e, r, i, t) {
		...
		case 'i64':
			...
			], HEAP32[e >> 2] = tempI64[0], HEAP32[e + 4 >> 2] = tempI64[1];
			break;
		case 'float':
			HEAPF32[e >> 2] = r;
			break;
	...
	var PATH = {
		...
		dirname: function (t) {
			var r = PATH.splitPath(t), i = r[0], e = r[1];
			if (!i && !e) {
				return '.';
			}
			if (e) {
	...
	var FS = {
		...
		createLazyFile: function (a, l, r, s, f) {
			...
			t.prototype.cacheLength = function h() {
				...
				var s = function (o, n) {
					if (o > n)
						throw new Error('invalid range (' + o + ', ' + n + ') or no bytes requested!');
					if (n > i - 1)
		...
		websocket_sock_ops: {
			createPeer: function (t, r, n) {
				...
				if (t.type === 2 && typeof t.sport !== 'undefined') {
					a.dgram_send_queue.push(new Uint8Array([
						255,
						255,
						255,
						255,
	...
	var asm = function (E, u, C) {
		...
		var sn = 0;
		var Jt = 0;
		var Gt = E.NaN, er = E.Infinity;
		var xt = 0, Zt = 0, tn = 0, ln = 0, un = 0, Lt = 0, Vn = 0, Wn = 0, Kn = 0;
		var m = 0;
		var qt = 0;
		var Ut = 0;
		var Kt = 0;
		...
		function ei(E, se, V, te, fe, Be, Ce, Y, ae) {
			...
			Y = Y | 0;
			ae = ae | 0;
			var N = 0, y = 0, C = 0, A = 0, v = 0, s = 0, _ = 0, m = 0, h = 0, w = 0, u = 0, n = 0, T = 0, B = 0, a = 0, j = 0, W = 0, Se = 0, Te = 0, Fe = 0, ge = 0, ke = 0, Pe = 0, ce = 0, Re = 0, _e = 0, pe = 0, he = 0, de = 0, Me = 0, Oe = 0, le = 0, me = 0, we = 0, R = 0, X = 0, M = 0, D = 0, Q = 0, H = 0, g = 0, qe = 0, ze = 0, Ve = 0, Ue = 0, $ = 0, F = 0, He = 0, xe = 0, Ie = 0, k = 0, re = 0, J = 0, oe = 0, ee = 0, ve = 0, Z = 0, be = 0, Le = 0, P = 0, U = 0, ye = 0, O = 0, S = 0, K = 0, ne = 0, x = 0, Ne = 0, De = 0, ie = 0, ue = 0, z = 0, q = 0, G = 0, Ee = 0, I = 0, L = 0;
			I = t;
			t = t + 26240 | 0;
			O = I + 21624 | 0;
			S = I + 21368 | 0;
			...
			if ((_ | 0) > 0)
				if ((D | 0) > 2) {
					...
					do {
						...
						w = 0;
						do {
							r[O + (u * 2304 | 0) + (w << 2) >> 2] = +r[n + (w + 407 << 2) >> 2] - (+r[n + (w + 418 << 2) >> 2] + +r[n + (w + 397 << 2) >> 2]) * 1.7303260184043527e-17 - (+r[n + (w + 417 << 2) >> 2] + +r[n + (w + 398 << 2) >> 2]) * 0.017031719908118248 - (+r[n + (w + 416 << 2) >> 2] + +r[n + (w + 399 << 2) >> 2]) * 1.3495279640235235e-17 + (+r[n + (w + 415 << 2) >> 2] + +r[n + (w + 400 << 2) >> 2]) * 0.04180720075964928 - (+r[n + (w + 414 << 2) >> 2] + +r[n + (w + 401 << 2) >> 2]) * 6.732779685849225e-17 - (+r[n + (w + 413 << 2) >> 2] + +r[n + (w + 402 << 2) >> 2]) * 0.08763240277767181 - (+r[n + (w + 412 << 2) >> 2] + +r[n + (w + 403 << 2) >> 2]) * 3.0835000291318875e-17 + (+r[n + (w + 411 << 2) >> 2] + +r[n + (w + 404 << 2) >> 2]) * 0.1863476037979126 - (+r[n + (w + 410 << 2) >> 2] + +r[n + (w + 405 << 2) >> 2]) * 1.1044240253100168e-16 - (+r[n + (w + 409 << 2) >> 2] + +r[n + (w + 406 << 2) >> 2]) * 0.6276379823684692;
							w = w + 1 | 0;
						} while ((w | 0) != 576);
			...
			if ((D | 0) > 0) {
				...
				do {
					...
					if (m < h * 1.7000000476837158 & (h < s ? (h > m ? h : m) < 40000 : 0)) {
						n = z + (M << 4) + 4 | 0;
						if ((e[u >> 2] | 0) <= (e[n >> 2] | 0))
							e[u >> 2] = 0;
						e[n >> 2] = 0;
					...
					if (a < s & (m < h ? (m > a ? m : a) < 40000 : 0))
						e[z + (M << 4) + 8 >> 2] = 0;
					s = +r[pe >> 2];
					if (s < h & (a < s * 1.7000000476837158 ? (a > s ? a : s) < 40000 : 0))
						e[z + (M << 4) + 12 >> 2] = 0;
					n = e[u >> 2] | 0;
					_ = e[E + 27780 + (M << 2) >> 2] | 0;
					if ((n | 0) <= (_ | 0)) {
					...
					w = z + (M << 4) + 4 | 0;
					u = e[w >> 2] | 0;
					if ((_ | 0) != 3 ? (u + n + (e[z + (M << 4) + 8 >> 2] | 0) | 0) == (0 - (e[z + (M << 4) + 12 >> 2] | 0) | 0) : 0)
						n = 1;
					else
						x = 47;
					do
			...
			if ((e[ve >> 2] | 0) == 1 ? ((e[q + 4 >> 2] | 0) + (e[q >> 2] | 0) | 0) == 2 : 0)
				ur(U, K, k + 768 | 0, (e[E + 85796 >> 2] | 0) + 212 | 0, N, +r[be >> 2], e[k + 2148 >> 2] | 0);
			if (ee) {
				_ = 0;
				do {
					F = U + (_ << 8) | 0;
				...
				do {
					...
					do {
						...
						do {
							...
							s = +r[(v ? ie + (A << 2) | 0 : y) >> 2];
							_ = e[z + (u << 4) + (T << 2) >> 2] | 0;
							if ((_ | 0) <= 1 ? (e[z + (u << 4) + (T + 1 << 2) >> 2] | 0) != 1 : 0)
								m = h;
							else if (h > 0)
		...
		function $r(M) {
			M = M | 0;
			var i = 0, o = 0, m = 0, a = 0, u = 0, s = 0, f = 0, T = 0, _ = 0, B = 0, E = 0, C = 0, I = 0, A = 0, P = 0, O = 0, N = 0, S = 0, n = 0, D = 0, R = 0, p = 0, y = 0, h = 0, b = 0, g = 0, w = 0;
			g = t;
			t = t + 768 | 0;
			O = g + 512 | 0;
			N = g + 256 | 0;
			...
			do {
				a = 0;
				do {
					r[n + 21564 + (i << 8) + (a << 2) >> 2] = 100000002004087730000;
					r[n + 22588 + (i << 8) + (a << 2) >> 2] = 100000002004087730000;
					r[n + 24636 + (i << 8) + (a << 2) >> 2] = 1;
					r[n + 23612 + (i << 8) + (a << 2) >> 2] = 1;
					a = a + 1 | 0;
				} while ((a | 0) != 64);
				r[n + 26636 + (i * 244 | 0) >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 4 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 4 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 8 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 8 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 12 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 12 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 16 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 16 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 20 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 20 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 24 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 24 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 28 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 28 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 32 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 32 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 36 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 36 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 40 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 40 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 44 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 44 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 48 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 48 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 52 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 52 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 56 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 56 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 60 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 60 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 64 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 64 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 68 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 68 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 72 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 72 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 76 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 76 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 80 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 80 >> 2] = 100000002004087730000;
				r[n + 26636 + (i * 244 | 0) + 84 >> 2] = 100000002004087730000;
				r[n + 25660 + (i * 244 | 0) + 84 >> 2] = 100000002004087730000;
				a = n + 27780 + (i << 2) | 0;
				o = 0;
				do {
					r[n + 26636 + (i * 244 | 0) + 88 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 88 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 100 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 100 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 112 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 112 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 124 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 124 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 136 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 136 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 148 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 148 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 160 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 160 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 172 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 172 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 184 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 184 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 196 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 196 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 208 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 208 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 220 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 220 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 26636 + (i * 244 | 0) + 232 + (o << 2) >> 2] = 100000002004087730000;
					r[n + 25660 + (i * 244 | 0) + 232 + (o << 2) >> 2] = 100000002004087730000;
					e[a >> 2] = 0;
					o = o + 1 | 0;
				} while ((o | 0) != 3);
			...
			if ((e[p >> 2] | 0) > 0) {
				...
				do {
					...
					if ((f | 0) > 0) {
						...
						s = 1e+37;
						do {
							w = +d(10, +((+L(R, +(a | 0) * b * 9.765625e-7 * 1000) + -20) * 0.1));
							f = e[i >> 2] | 0;
							w = +(f | 0) * w;
							s = s > w ? w : s;
							o = o + 1 | 0;
					...
					s = s > 6 ? 30 : s;
					r[B + (E << 2) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44000 ? 2.2 : ((s < u ? u : s) + -8) * 0.1));
					E = E + 1 | 0;
				} while ((E | 0) < (e[p >> 2] | 0));
			}
			A = h + 2160 | 0;
				...
				if ((a | 0) > 0) {
					...
					while (1) {
						...
						if ((f | 0) > 0) {
							...
							s = 1e+37;
							do {
								w = +d(10, +((+L(R, +(a | 0) * b * 0.00000390625 * 1000) + -20) * 0.1));
								f = e[B >> 2] | 0;
								w = +(f | 0) * w;
								s = s > w ? w : s;
								o = o + 1 | 0;
						...
						if (u < 12)
							s = (+Ve(+(1 - s)) * 2.3 + 1) * s;
						u = s > 6 ? 30 : s;
						r[E + (_ << 2) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44000 ? 2.2 : ((u < m ? m : u) + -8) * 0.1));
						_ = _ + 1 | 0;
						a = e[C >> 2] | 0;
						if ((_ | 0) >= (a | 0))
							break;
			...
			if ((o | 0) < 4)
				...
				s = +r[11720 + (o << 2) >> 2];
				s = ((s - +r[11720 + (o + 1 << 2) >> 2]) * +r[M + 160 >> 2] + s) * 0.10000000149011612;
			}
			if ((i | 0) > 0) {
				a = (i | 0) > 1;
				m = +(i | 0);
		...
		function ur(c, u, w, E, _, t, h) {
			...
			t = +t;
			h = h | 0;
			var n = 0, i = 0, l = 0, a = 0, d = 0, f = 0, m = 0, s = 0, e = 0, o = 0, p = 0, S = 0, v = 0;
			S = t * 2;
			if ((h | 0) <= 0)
				return;
			if (t > 0)
		...
		function Ae(f, h, m, u, l) {
			...
			u = u | 0;
			l = l | 0;
			var i = 0, n = 0, a = 0, t = 0, o = 0, p = 0, _ = 0, c = 0, s = 0, d = 0, w = 0;
			d = e[f + 2152 >> 2] | 0;
			e:
				do
					if ((d | 0) > 0) {
		...
		function Te(s, o, n, i, w, v) {
			...
			w = w | 0;
			v = v | 0;
			var h = 0, a = 0, f = 0, u = 0, l = 0, m = 0, S = 0, p = 0, _ = 0, E = 0, b = 0, k = 0;
			E = t;
			t = t + 2320 | 0;
			p = E + 2052 | 0;
			_ = E;
			...
			if ((n | 0) > 0) {
				...
				while (1) {
					a = e[s + 1716 + (i << 2) >> 2] | 0;
					o = +F(+(((a | 0) / 2 | 0) + n | 0) * u);
					r[s + 768 + (i << 2) >> 2] = +d(10, +((1 - +N(+(o < 15.5 ? o * 0.2026833970057931 : 3.141592653589793))) * 1.25 + -2.5));
					i = i + 1 | 0;
					if ((i | 0) < (e[f >> 2] | 0))
						n = a + n | 0;
					else
			...
			do {
				...
				r[s + 1112 + (a << 2) >> 2] = o;
				o = +F(+(n | 0) * S);
				r[s + 1024 + (a << 2) >> 2] = +d(10, +((1 - +N(+(o < 15.5 ? o * 0.2026833970057931 : 3.141592653589793))) * 1.25 + -2.5));
			} while ((i | 0) != (w | 0));
			t = E;
			return;
		}
		function hr(w, h, u, f, s, i) {
			...
			s = s | 0;
			i = i | 0;
			var n = 0, a = 0, o = 0, d = 0, S = 0, E = 0, p = 0, m = 0, _ = 0;
			_ = t;
			t = t + 16384 | 0;
			m = _;
			c(m | 0, 0, 16384) | 0;
		...
		function Xr(n, m, S, k) {
			...
			S = S | 0;
			k = k | 0;
			var _ = 0, p = 0, h = 0, u = 0, o = 0, a = 0, M = 0, E = 0, g = 0, i = 0, f = 0, b = 0, w = 0, R = 0, G = 0, X = 0, K = 0, Y = 0, A = 0, F = 0, I = 0, D = 0, W = 0, q = 0, O = 0, B = 0, V = 0, z = 0, L = 0, U = 0, N = 0, C = 0, j = 0, y = 0, x = 0;
			y = t;
			t = t + 10592 | 0;
			O = y + 5336 | 0;
			B = y + 3032 | 0;
							...
							if (_) {
								...
								while (1) {
									...
									if ((g | 0) > 0) {
										...
										while (1) {
											E = +(i | 0);
											r[f >> 2] = (E * E * 0.00005991735537190083 + 1) * +r[f >> 2];
											i = i + 1 | 0;
											if ((i | 0) == (g | 0))
												break;
											else
					...
					if ((e[R >> 2] | 0) > 0) {
						...
						do {
							...
							if (+r[O >> 2] > 9.999999682655225e-21) {
								...
								c(n + 304 + (S * 10504 | 0) + (m * 5252 | 0) + 2304 | 0, 0, 2304) | 0;
							m = m + 1 | 0;
						} while ((m | 0) < (e[R >> 2] | 0));
						p = e[C >> 2] | 0;
					}
		...
		function Kr(i, D, n, L) {
			...
			n = n | 0;
			L = L | 0;
			var o = 0, l = 0, f = 0, y = 0, a = 0, h = 0, _ = 0, u = 0, p = 0, x = 0, m = 0, A = 0, O = 0, v = 0, N = 0, k = 0, b = 0, F = 0, E = 0, S = 0, I = 0, g = 0, R = 0, w = 0, C = 0, B = 0;
			w = t;
			t = t + 9936 | 0;
			I = w;
			b = w + 9932 | 0;
		...
		function Yr(n, F, m, B) {
			...
			m = m | 0;
			B = B | 0;
			var h = 0, i = 0, w = 0, l = 0, f = 0, o = 0, u = 0, _ = 0, L = 0, v = 0, k = 0, a = 0, U = 0, p = 0, E = 0, z = 0, O = 0, R = 0, D = 0, b = 0, M = 0, A = 0, I = 0, N = 0, S = 0, g = 0, C = 0, y = 0, x = 0;
			y = t;
			t = t + 2496 | 0;
			S = y + 2484 | 0;
			I = y + 2328 | 0;
						...
						do {
							...
							if ((e[R >> 2] | 0) > 0) {
								...
								do {
									...
									r[L >> 2] = +d(10, +(+r[((e[n + 304 + (a * 10504 | 0) + (i * 5252 | 0) + 4788 >> 2] | 0) == 2 ? h : _) >> 2] * 0.1));
									Se(n, l);
									r[S >> 2] = 0;
		...
		function jr(i, v, g, l) {
			...
			g = g | 0;
			l = l | 0;
			var s = 0, a = 0, u = 0, o = 0, m = 0, L = 0, S = 0, D = 0, N = 0, A = 0, y = 0, R = 0, O = 0, F = 0, M = 0, n = 0, k = 0, h = 0, _ = 0, p = 0, w = 0, f = 0, E = 0, b = 0;
			f = t;
			t = t + 2480 | 0;
			_ = f + 2476 | 0;
			k = f + 2320 | 0;
			...
			do {
				...
				if ((e[y >> 2] | 0) > 0) {
					...
					do {
						...
						r[F >> 2] = +d(10, +(+r[((e[i + 304 + (n * 10504 | 0) + (o * 5252 | 0) + 4788 >> 2] | 0) == 2 ? O : R) >> 2] * 0.1));
						Se(i, s);
						r[_ >> 2] = 0;
						...
						if (+r[_ >> 2] > 9.999999682655225e-21) {
							...
							c(i + 304 + (n * 10504 | 0) + (o * 5252 | 0) + 2304 | 0, 0, 2304) | 0;
						Oe(i, n, o, L);
						if ((e[N >> 2] | 0) == 1)
							oe(i, s);
						le(i, s);
		...
		function Se(h, n) {
			h = h | 0;
			n = n | 0;
			var d = 0, o = 0, s = 0, a = 0, f = 0, u = 0, w = 0, i = 0, m = 0, E = 0, _ = 0, k = 0, v = 0, b = 0, S = 0;
			b = t;
			t = t + 2304 | 0;
			v = b;
			e[n + 4768 >> 2] = 0;
		...
		function xe(v, F, G, M, i, ee) {
			...
			i = i | 0;
			ee = ee | 0;
			var o = 0, n = 0, u = 0, E = 0, y = 0, S = 0, R = 0, w = 0, N = 0, U = 0, f = 0, a = 0, m = 0, d = 0, Y = 0, _e = 0, pe = 0, ne = 0, te = 0, Z = 0, $ = 0, he = 0, x = 0, P = 0, W = 0, L = 0, de = 0, j = 0, T = 0, z = 0, ie = 0, Ee = 0, ve = 0, Se = 0, ce = 0, me = 0, V = 0, q = 0, le = 0, se = 0, A = 0, D = 0, re = 0, we = 0, oe = 0, O = 0, be = 0, J = 0, ue = 0, K = 0, Q = 0, _ = 0, k = 0, h = 0, C = 0, g = 0, H = 0, X = 0, B = 0, fe = 0;
			B = t;
			t = t + 8256 | 0;
			h = B + 2992 | 0;
			X = B + 688 | 0;
			...
			while (1) {
				...
				e:
					while (1) {
						...
						while (1) {
							if ((e[h + 4608 + (n << 2) >> 2] | 0) == (0 - (e[h + 4808 + (e[h + 5028 + (n << 2) >> 2] << 2) >> 2] | 0) | 0))
								break;
							n = n + 1 | 0;
							if ((n | 0) >= (o | 0))
								break e;
							...
							r:
								do
									if (!(e[x >> 2] | 0)) {
										...
										while (1) {
											if ((e[h + 4608 + (o << 2) >> 2] | 0) == (0 - (e[h + 4808 + (e[h + 5028 + (o << 2) >> 2] << 2) >> 2] | 0) | 0))
												break r;
											o = o + 1 | 0;
											if ((o | 0) >= (i | 0)) {
												_ = 167;
								...
								case 4: {
										...
										do
											if (d <= 0) {
												...
												if (!(f > 0.2)) {
													...
													if (!(!(m > 0) | i ^ 1) ? +r[A >> 2] < +r[k >> 2] + +r[D >> 2] : 0)
														i = 1;
													else
														_ = 130;
												} else
										...
										do
											if ((_ | 0) == 130) {
												...
												if (d > 0) {
													f = +r[q >> 2];
													if (f > -0.05 & f > a + -0.1 ? +r[g >> 2] + +r[A >> 2] < +r[k >> 2] + +r[D >> 2] : 0) {
														i = 1;
														break;
													}
													if (f > -0.1 & f > a + -0.15)
		...
		function kr(S, s, v, l) {
			...
			v = v | 0;
			l = l | 0;
			var a = 0, n = 0, o = 0, u = 0, i = 0, f = 0, w = 0, m = 0, k = 0, y = 0, b = 0, _ = 0, E = 0, M = 0, c = 0, d = 0, g = 0, h = 0;
			h = t;
			t = t + 192 | 0;
			g = h + 24 | 0;
			n = h;
		...
		function zr(t) {
			t = t | 0;
			var o = 0, i = 0, l = 0, a = 0, f = 0, u = 0, c = 0, m = 0, _ = 0, p = 0, w = 0, E = 0, n = 0, s = 0, h = 0;
			o = t + 8 | 0;
			if (e[o >> 2] | 0)
				return;
			e[o >> 2] = 1;
		...
		function ze(a, u, m, n, _, o) {
			...
			_ = _ | 0;
			o = o | 0;
			var i = 0, d = 0, E = 0, h = 0, c = 0, w = 0, p = 0, f = 0, l = 0;
			l = t;
			t = t + 16 | 0;
			w = l + 12 | 0;
			h = l + 8 | 0;
		...
		function ye(e, r, i, t) {
			...
			if (e > 9.999999682655225e-21)
				...
				e = 0;
			return + +d(10, +((i + 90.30873107910156 + (t < 1 ? -94.82444763183594 : -t) + (e < 0 ? 0 : e) * r) * 0.10000000149011612));
		}
		function J(S, v, h, f) {
			S = S | 0;
			v = v | 0;
			h = h | 0;
			f = f | 0;
			var E = 0, a = 0, s = 0, t = 0, l = 0, c = 0, o = 0, n = 0, w = 0, m = 0, g = 0, M = 0, O = 0, _ = 0, y = 0, u = 0, R = 0, k = 0, C = 0, L = 0, P = 0, B = 0, D = 0, F = 0, A = 0, N = 0, T = 0;
			F = e[S + 85796 >> 2] | 0;
			O = h + 4856 | 0;
			if ((e[O >> 2] | 0) > 0) {
				_ = F + 8 | 0;
				...
				while (1) {
					...
					if (t > 9.999999682655225e-21)
						...
						l = 0;
					l = +d(10, +((c + 90.30873107910156 + (o < 1 ? -94.82444763183594 : -o) + (l < 0 ? 0 : l) * n) * 0.10000000149011612));
					M = +r[S + 84768 + (a << 2) >> 2];
					l = M * l;
					m = e[h + 4872 + (a << 2) >> 2] | 0;
					c = l / +(m | 0);
					...
					t = o < l ? o : n < l ? l : n;
					l = +r[v + 244 + (a << 2) >> 2];
					if (l > 9.999999960041972e-13 ? (u = M * (+r[v + (a << 2) >> 2] * o / l), t < u) : 0)
						t = u;
			...
			if (s)
				...
				a = a | 1;
			if ((e[S + 85092 >> 2] | 0) == 0 ? (k = e[S + 64 >> 2] | 0, (k | 0) < 44000) : 0) {
				f = (k | 0) < 8001;
				if (s)
			...
			while (1) {
				...
				if (o > 9.999999682655225e-21)
					...
					n = 0;
				u = +d(10, +((c + 90.30873107910156 + (l < 1 ? -94.82444763183594 : -l) + (n < 0 ? 0 : n) * t) * 0.10000000149011612));
				R = S + 84856 + (_ << 2) | 0;
				l = +r[R >> 2];
				u = l * u;
				k = e[h + 4872 + (m << 2) >> 2] | 0;
				...
				if ((k | 0) > 0) {
					...
					n = c < u ? c : n < u ? u : n;
					o = +r[v + 332 + (_ * 12 | 0) >> 2];
					if (o > 9.999999960041972e-13 ? (A = l * (+r[v + 88 + (_ * 12 | 0) >> 2] * c / o), n < A) : 0)
						n = A;
					...
					if (o > 9.999999960041972e-13 ? (N = +r[R >> 2] * (+r[v + 88 + (_ * 12 | 0) + 4 >> 2] * c / o), n < N) : 0)
						n = N;
					o = n > 2.220446049250313e-16 ? n : 2.220446049250313e-16;
					...
					if (n > 9.999999960041972e-13 ? (T = +r[R >> 2] * (+r[v + 88 + (_ * 12 | 0) + 8 >> 2] * o / n), l < T) : 0)
						l = T;
		...
		function Fe(n, A, E, w, _) {
			...
			w = w | 0;
			_ = _ | 0;
			var k = 0, g = 0, R = 0, i = 0, a = 0, f = 0, o = 0, l = 0, L = 0, y = 0, u = 0, d = 0, T = 0, c = 0, M = 0, P = 0, B = 0, U = 0, H = 0, I = 0, C = 0, x = 0, v = 0, N = 0, m = 0, O = 0, D = 0, h = 0, S = 0, F = 0;
			D = t;
			t = t + 16 | 0;
			O = D;
			P = w + 16 | 0;
		...
		function Ur(u, _) {
			u = u | 0;
			_ = _ | 0;
			var m = 0, d = 0, a = 0, p = 0, h = 0, n = 0, P = 0, A = 0, S = 0, v = 0, c = 0, y = 0, g = 0, D = 0, b = 0, E = 0, C = 0, N = 0, w = 0, L = 0, ie = 0, te = 0, ne = 0, G = 0, T = 0, R = 0, z = 0, re = 0, i = 0, o = 0, ee = 0, Y = 0, $ = 0, x = 0, X = 0, V = 0, U = 0, W = 0, H = 0, K = 0, j = 0, B = 0, Z = 0, Q = 0, k = 0, F = 0, q = 0, O = 0, I = 0, M = 0;
			M = t;
			t = t + 496 | 0;
			k = M + 340 | 0;
			O = M + 184 | 0;
			...
			do {
				if ((d | 0) > 0) {
					...
					do {
						...
						R = (e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4836 >> 2] | 0) == 0 ? 0.5 : 1;
						...
						if ((I | 0) == 13) {
							...
							do {
								...
								if (A & (c | 0) > 10) {
									...
									h = 0;
								if ((c | 0) < 21)
									f[a >> 3] = h - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (c << 2) >> 2] | 0) * R;
							} while ((v | 0) != (d | 0));
						}
						if (y ? (x = e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4852 >> 2] | 0, (x | 0) < 13) : 0) {
							...
							while (1) {
								...
								C = (E | 0) < 12;
								if ((T | 0) <= (A | 0)) {
									f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (g << 3) >> 3] = 0.000009999999747378752;
									...
									f[a >> 3] = n;
									if (C)
										f[a >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (d << 2) >> 2] | 0) * R;
									c = d + 1 | 0;
									a = g + 1 | 0;
									f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = 0.000009999999747378752;
									...
									f[a >> 3] = n;
									if (C)
										f[a >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (c << 2) >> 2] | 0) * R;
									c = d + 2 | 0;
									a = g + 2 | 0;
									f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = 0.000009999999747378752;
									f[w + 201912 + (o * 624 | 0) + (i * 312 | 0) + (a << 3) >> 3] = +r[k + (c << 2) >> 2] * 999999986991104 * +r[O + (c << 2) >> 2] / D;
									...
									while (1) {
										...
										f[c >> 3] = n;
										if (C)
											f[c >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (m << 2) >> 2] | 0) * R;
										a = a + 1 | 0;
										if ((a | 0) == 3)
											break;
										else
		...
		function mr(l, a, p) {
			...
			a = a | 0;
			p = p | 0;
			var r = 0, n = 0, s = 0, E = 0, h = 0, f = 0, _ = 0, w = 0, d = 0, c = 0, v = 0, u = 0, m = 0;
			m = t;
			t = t + 16 | 0;
			u = m;
			e[u >> 2] = 0;
			...
			while (1) {
				...
				r = n + -2 | 0;
				if (!(e[a + 2304 + (r << 2) >> 2] | e[a + 2304 + (n + -1 << 2) >> 2]))
					n = r;
				else {
					d = 6;
					break;
			...
			if (!r) {
				...
				if ((s | 0) < (n | 0))
					e[a + 4804 >> 2] = y[e[l + 85816 >> 2] & 3](a + 2304 + (s << 2) | 0, a + 2304 + (n << 2) | 0, u) | 0;
			} else if ((r | 0) == 2) {
				r = (e[l + 21464 >> 2] | 0) * 3 | 0;
				r = (r | 0) > (n | 0) ? n : r;
				s = n;
			...
			if ((r | 0) < (n | 0))
				e[a + 4800 >> 2] = y[e[l + 85816 >> 2] & 3](a + 2304 + (r << 2) | 0, a + 2304 + (n << 2) | 0, u) | 0;
			if ((e[l + 36 >> 2] | 0) == 2) {
				c = a + 4768 | 0;
				e[c >> 2] = e[u >> 2];
				oe(l, a);
		...
		function oe(p, r) {
			p = p | 0;
			r = r | 0;
			var n = 0, i = 0, s = 0, c = 0, w = 0, m = 0, v = 0, O = 0, F = 0, M = 0, E = 0, f = 0, d = 0, _ = 0, k = 0, S = 0, g = 0, b = 0, a = 0, R = 0, A = 0, T = 0, u = 0, h = 0;
			h = t;
			t = t + 5632 | 0;
			b = h + 5624 | 0;
			d = h + 5620 | 0;
			...
			if (!(e[u + 4788 >> 2] | 0)) {
				...
				if ((s | 0) > (n | 0))
					e[u + 4800 >> 2] = y[e[p + 85816 >> 2] & 3](r + 2304 + (n << 2) | 0, r + 2304 + (s << 2) | 0, i) | 0;
		...
		function I(y, k, f, w) {
			...
			f = f | 0;
			w = w | 0;
			var v = 0, o = 0, i = 0, s = 0, t = 0, l = 0, n = 0, u = 0, d = 0, g = 0, _ = 0, b = 0, E = 0, M = 0, R = 0, N = 0, F = 0, C = 0, D = 0, L = 0, S = 0, a = 0, A = 0, h = 0, p = 0, O = 0, P = 0, T = 0, m = 0;
			O = f + 4780 | 0;
			i = e[O >> 2] | 0;
			p = +r[79704 + (i << 2) >> 2];
			...
			if ((e[y + 85096 >> 2] & 2 | 0) != 0 ? (P = 0.634521682242439 / +r[79704 + ((e[A >> 2] | 0) + (e[O >> 2] | 0) << 2) >> 2], T = f + 4860 | 0, v = e[T >> 2] | 0, (v | 0) > 0) : 0) {
				s = 0;
				t = 0;
				do {
					a = e[f + 4872 + (t << 2) >> 2] | 0;
		...
		function Oe(g, d, n, t) {
			...
			n = n | 0;
			t = t | 0;
			var i = 0, l = 0, r = 0, a = 0, o = 0, m = 0, u = 0, f = 0, M = 0, V = 0, U = 0, E = 0, B = 0, P = 0, b = 0, T = 0, I = 0, y = 0, W = 0, R = 0, F = 0, h = 0, A = 0, k = 0, N = 0, D = 0, S = 0, L = 0, C = 0, v = 0, O = 0, x = 0, H = 0, _ = 0, z = 0, q = 0, p = 0, j = 0, Y = 0, w = 0;
					...
					do
						if (a) {
							...
							do {
								...
								if ((h | 0) > -1 ? (e[t + (n * 5252 | 0) + 4608 + (r << 2) >> 2] | 0) != (h | 0) : 0)
									break e;
								r = r + 1 | 0;
							} while ((r | 0) < (f | 0));
						} else
		...
		function We(w, i) {
			w = w | 0;
			i = i | 0;
			var a = 0, r = 0, o = 0, f = 0, n = 0, c = 0, l = 0, d = 0, u = 0, E = 0, B = 0, C = 0, L = 0, M = 0, b = 0, I = 0, A = 0, k = 0, g = 0, y = 0, h = 0, F = 0, O = 0, R = 0, S = 0, T = 0, N = 0, D = 0, P = 0, m = 0, _ = 0, p = 0, v = 0;
			v = t;
			t = t + 16 | 0;
			p = v;
			if ((e[w + 76 >> 2] | 0) == 2) {
		...
		function ne(a, i, s, t) {
			...
			s = s | 0;
			t = t | 0;
			var l = 0, f = 0, h = 0, m = 0, o = 0, d = 0, u = 0, c = 0;
			m = a & 2;
			l = a >>> 2;
			if (!l)
				a = t;
		...
		function Fi(o, a, u) {
			...
			a = a | 0;
			u = u | 0;
			var r = 0, i = 0, t = 0, s = 0, f = 0, n = 0, l = 0, c = 0;
			t = o;
			i = 0;
			r = 0;
			do {
		...
		function Ti(r, a, i, d) {
			...
			i = i | 0;
			d = d | 0;
			var f = 0, t = 0, w = 0, p = 0, l = 0, u = 0, h = 0, n = 0, m = 0, c = 0;
			n = e[89504 + (i + -1 << 2) >> 2] | 0;
			p = e[82272 + (n << 4) >> 2] | 0;
		...
		function L(o, i) {
			...
			case 3: {
					...
					n = i + -3.4;
					t = i + -8.7;
					i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 0.0006399999999999999 + 6;
					return +i;
				}
			case 1: {
					i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
					...
					n = i + -3.4;
					t = i + -8.7;
					i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 0.00056;
					return +i;
				}
			case 4: {
					i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
					...
					n = i + -3.4;
					t = i + -8.7;
					i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * (+r[o + 188 >> 2] * 0.00004 + 0.0006);
					return +i;
				}
			case 0: {
					i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
					...
					n = i + -3.4;
					t = i + -8.7;
					i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 0.0009599999999999999;
					return +i;
				}
			case 5: {
					i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
			...
			case 2: {
					...
					n = i + -3.4;
					t = i + -8.7;
					i = +d(+i, -0.8) * 3.64 - +v(+(n * n * -0.6)) * 6.8 + +v(+(t * t * -0.15)) * 6 + +d(+i, 4) * 0.0006;
					return +i;
				}
			default: {
					i = i < -0.3 ? 3.4100000858306885 : i * 0.0010000000474974513;
		...
		function pr(c, A, C, E, D, T) {
			...
			D = D | 0;
			T = T | 0;
			var o = 0, i = 0, u = 0, n = 0, t = 0, a = 0, d = 0, S = 0, w = 0, h = 0, M = 0, b = 0, y = 0, Y = 0, F = 0, G = 0, j = 0, R = 0, g = 0, K = 0, s = 0, _ = 0, v = 0, P = 0, W = 0, H = 0, U = 0, V = 0, q = 0, m = 0, L = 0, I = 0, B = 0, z = 0, O = 0;
			B = e[c + 84036 >> 2] | 0;
			u = e[c + 76 >> 2] | 0;
			L = u * 576 | 0;
			z = e[c + 72 >> 2] | 0;
			...
			H = c + 60 | 0;
			i = e[H >> 2] | 0;
			if ((i | 0) >= (~~(a * 0.9994999766349792) | 0) ? (~~(a * 1.000499963760376) | 0) >= (i | 0) : 0) {
				o = (L | 0) < (E | 0) ? L : E;
				i = o << 2;
				u = 0;
				do {
						...
						while (1) {
							...
							while (1) {
								...
								if (+p(+S) < 1e-9)
									...
									a = (0.42 - +N(+(a * 2 * 3.141592653589793)) * 0.5 + +N(+(a * 4 * 3.141592653589793)) * 0.08) * +Lr(+(F * S)) / (G * S);
								r[n + (h << 2) >> 2] = a;
								d = a + d;
								if ((h | 0) < (s | 0))
									h = h + 1 | 0;
		...
		function $i(f, r, h, _) {
			...
			h = h | 0;
			_ = _ | 0;
			var n = 0, o = 0, i = 0, a = 0, m = 0, w = 0, p = 0, S = 0, c = 0, u = 0, O = 0, R = 0, T = 0, A = 0, k = 0, v = 0, d = 0, y = 0, M = 0, E = 0, b = 0, F = 0;
			F = t;
			t = t + 688 | 0;
			y = F + 424 | 0;
			d = F + 192 | 0;
		...
		function lt(i) {
			i = i | 0;
			var r = 0, t = 0, a = 0, n = 0, s = 0, f = 0, o = 0;
		...
		function ut(n) {
			...
			if ((n | 0) == 1)
				...
				o = (e[r + 64 >> 2] | 0) < 16000 ? 32 : 64;
			if (!(e[r + 104 >> 2] | 0))
				o = e[r + 120 >> 2] | 0;
			a = s((n * 72000 | 0) + 72000 | 0, o) | 0;
			a = (a | 0) / (e[r + 64 >> 2] | 0) | 0;
			o = (e[r + 24 >> 2] | 0) + 156 | 0;
			n = r + 85792 | 0;
			e[n >> 2] = a;
		...
		function dt(t, n) {
			t = t | 0;
			n = n | 0;
			var a = 0, r = 0, c = 0, s = 0, u = 0, l = 0, f = 0;
			i[n >> 0] = -1;
			u = n + 1 | 0;
			s = (o[u >> 0] | 0) << 3 | 7;
			i[u >> 0] = s;
		...
		function ee(i) {
			...
			return ((s((t * 72000 | 0) + 72000 | 0, e[r >> 2] | 0) | 0) / (e[i + 64 >> 2] | 0) | 0) + (e[i + 84752 >> 2] | 0) << 3 | 0;
		}
		function Dr(i, n) {
			i = i | 0;
			n = n | 0;
			...
			if ((r | 0) > 320) {
				t = e[i >> 2] | 0;
				if ((n | 0) == 1) {
					r = ((s((t * 72000 | 0) + 72000 | 0, r) | 0) / (e[i + 48 >> 2] | 0) | 0) << 3;
					return r | 0;
				} else {
					r = (t * 7680 | 0) + 7680 | 0;
					return r | 0;
			...
			if ((n | 0) == 1) {
				t = e[i + 48 >> 2] | 0;
				r = ((s((r * 72000 | 0) + 72000 | 0, e[((t | 0) < 16000 ? 83944 + (r << 6) + 32 | 0 : 83944 + (r << 6) + 56 | 0) >> 2] | 0) | 0) / (t | 0) | 0) << 3;
				return r | 0;
			} else if ((n | 0) == 2) {
				r = (r * 7680 | 0) + 7680 | 0;
				return r | 0;
		...
		function pt(r) {
			...
			i = (((s((i * 72000 | 0) + 72000 | 0, e[n >> 2] | 0) | 0) / (e[r + 64 >> 2] | 0) | 0) + (e[r + 84752 >> 2] | 0) << 3) + a | 0;
			if ((i | 0) < 0) {
				M(r, 1072, f);
				t = f;
				return;
		...
		function Pe(t, r, s) {
			...
			r = r | 0;
			s = s | 0;
			var n = 0, h = 0, f = 0, l = 0, u = 0, c = 0, a = 0, d = 0;
			if (!s)
				return;
			h = r & 255;
			f = t + 300 | 0;
		...
		function Et(u) {
			u = u | 0;
			var m = 0, r = 0, n = 0, d = 0, a = 0, k = 0, _ = 0, E = 0, T = 0, x = 0, v = 0, R = 0, g = 0, P = 0, D = 0, S = 0, F = 0, b = 0, H = 0, y = 0, h = 0, f = 0, V = 0, A = 0, I = 0, C = 0, p = 0, U = 0, w = 0, Y = 0, z = 0, j = 0, q = 0, W = 0, K = 0, N = 0, G = 0, Q = 0, $ = 0, X = 0, Z = 0, J = 0, B = 0, L = 0;
			L = t;
			t = t + 96 | 0;
			J = L + 88 | 0;
			Z = L + 80 | 0;
			...
			q = u + 84752 | 0;
			j = u + 64 | 0;
			W = ((s((m * 72000 | 0) + 72000 | 0, e[r >> 2] | 0) | 0) / (e[j >> 2] | 0) | 0) + (e[q >> 2] | 0) << 3;
			K = u + 21320 | 0;
			Re(u, e[K >> 2] | 0);
			w = u + 52128 | 0;
			r = e[w >> 2] | 0;
			...
			m = (((s((r * 72000 | 0) + 72000 | 0, e[n >> 2] | 0) | 0) / (e[j >> 2] | 0) | 0) + (e[q >> 2] | 0) << 3) + m | 0;
			if ((m | 0) < 0)
				M(u, 1072, G);
			n = u + 52140 | 0;
			if ((m | 0) != (e[n >> 2] | 0)) {
		...
		function $(i, w, a, f) {
			...
			a = a | 0;
			f = f | 0;
			var s = 0, m = 0, u = 0, n = 0, p = 0, E = 0, _ = 0, o = 0, h = 0, c = 0, d = 0;
			d = t;
			t = t + 9216 | 0;
			h = d;
			s = i + 296 | 0;
		...
		function Re(u, w) {
			u = u | 0;
			w = w | 0;
			var r = 0, a = 0, t = 0, n = 0, s = 0, d = 0, f = 0, h = 0, c = 0, m = 0, p = 0, E = 0, _ = 0;
			if ((w | 0) > 7) {
				d = u + 300 | 0;
				f = u + 296 | 0;
				h = u + 52132 | 0;
		...
		function O(c, w, E, k, g) {
			...
			k = k | 0;
			g = g | 0;
			var t = 0, n = 0, u = 0, a = 0, f = 0, d = 0, b = 0, p = 0, _ = 0, m = 0, S = 0, h = 0, v = 0, y = 0, F = 0, M = 0, O = 0, R = 0, A = 0;
			M = e[82272 + (w << 4) >> 2] | 0;
			if (!((w | 0) != 0 & (E | 0) < (k | 0))) {
				k = 0;
				return k | 0;
		...
		function lr(s, t) {
			s = s | 0;
			t = t | 0;
			var f = 0, n = 0, a = 0, S = 0, g = 0, c = 0, _ = 0, u = 0, p = 0, m = 0, d = 0, w = 0, h = 0, E = 0, b = 0, k = 0, v = 0;
			f = (e[t + 4840 >> 2] | 0) + 32 | 0;
			a = e[t + 4772 >> 2] | 0;
			n = (e[t + 4776 >> 2] | 0) - a | 0;
			if ((n | 0) <= 3) {
		...
		function sr(a, g, A, G, Y) {
			...
			G = G | 0;
			Y = Y | 0;
			var u = 0, m = 0, w = 0, d = 0, i = 0, o = 0, h = 0, _ = 0, v = 0, F = 0, O = 0, ae = 0, oe = 0, ne = 0, te = 0, X = 0, R = 0, re = 0, ee = 0, Q = 0, J = 0, se = 0, ie = 0, Z = 0, C = 0, U = 0, S = 0, T = 0, N = 0, B = 0, y = 0, P = 0, D = 0, M = 0, x = 0, L = 0, b = 0, E = 0, p = 0, q = 0, z = 0, I = 0, k = 0, W = 0, j = 0, V = 0, K = 0;
			k = t;
			t = t + 20112 | 0;
			T = k + 12056 | 0;
			N = k + 4000 | 0;
				...
				do
					if ((o | 0) > 0) {
						...
						while (1) {
							...
							if ((e[m >> 2] | 0) == 1 ? (U = +r[D + (u << 4) + 12 >> 2], C = U + +r[D + (u << 4) + 8 >> 2], B = q + (u << 2) | 0, r[B >> 2] = C, C > 0) : 0)
								r[B >> 2] = U / C;
							o = e[w >> 2] | 0;
							if ((o | 0) > 0) {
								i = 0;
			...
			if ((p | 0) == 3 | (p | 0) == 0) {
				...
				if (d & (g | 0) > 0) {
					...
					O = 0;
				r[i >> 2] = O;
				_ = +(s(u * 3350 | 0, g) | 0) / ((U + C) * 0.9354900121688843 + ((Z + ie) * 0.7568249702453613 + ((se + J) * 0.5045499801635742 + ((Q + ee) * 0.23387250304222107 + ((re + R) * 3.8980449615198e-17 + ((X + te) * -0.1559150069952011 + ((ne + oe) * -0.21623599529266357 + ((ae + _) * -0.18920649588108063 + ((O + v) * -0.10394349694252014 + F)))))))));
				if (d & (g | 0) > 0) {
					o = 0;
					do {
						h = 0;
		...
		function Mt(i, E, _, p) {
			...
			_ = _ | 0;
			p = p | 0;
			var m = 0, v = 0, w = 0, d = 0, S = 0, c = 0, h = 0, n = 0, t = 0, f = 0, u = 0, a = 0, l = 0;
			S = p + (_ << 2) | 0;
			_ = i + 85820 | 0;
			m = 0;
			v = E;
		...
		function Ft(w, m, c, n) {
			...
			c = c | 0;
			n = n | 0;
			var h = 0, i = 0, d = 0, a = 0, s = 0, u = 0, l = 0, t = 0, f = 0;
			n = e[n + (c << 2) >> 2] | 0;
			c = m + 2048 | 0;
			h = 127;
			while (1) {
		...
		function Ot(t) {
			...
			do {
				n = +(i | 0) + 0.5;
				r[2360 + (i << 2) >> 2] = 0.42 - +N(+(n * 0.006135923151542565)) * 0.5 + +N(+(n * 0.01227184630308513)) * 0.08;
				i = i + 1 | 0;
			} while ((i | 0) != 1024);
			i = 0;
			do {
		...
		function Rt(w, n) {
			w = w | 0;
			n = n | 0;
			var o = 0, s = 0, t = 0, a = 0, h = 0, e = 0, l = 0, f = 0, A = 0, O = 0, T = 0, y = 0, g = 0, u = 0, p = 0, _ = 0, d = 0, v = 0, M = 0, b = 0, k = 0, D = 0, S = 0, F = 0, i = 0, R = 0, c = 0, E = 0, N = 0, m = 0;
			A = n << 1;
			O = w + (A << 2) | 0;
			u = 4;
			_ = 6456;
		...
		function or(u, p, d) {
			...
			p = p | 0;
			d = d | 0;
			var a = 0, s = 0, r = 0, f = 0, y = 0, n = 0, o = 0, l = 0, h = 0, m = 0, w = 0, E = 0, F = 0, k = 0, _ = 0, M = 0, g = 0, v = 0, b = 0;
			v = t;
			t = t + 1040 | 0;
			a = v;
			m = v + 8 | 0;
		...
		function Nt(r, o, a) {
			...
			o = o | 0;
			a = a | 0;
			var n = 0, s = 0, f = 0, _ = 0, h = 0, E = 0, l = 0, m = 0, w = 0, d = 0, p = 0, u = 0, c = 0;
			c = t;
			t = t + 16 | 0;
			l = c;
			m = c + 4 | 0;
		...
		function Pt(r, a, u, d, w) {
			...
			d = d | 0;
			w = w | 0;
			var t = 0, o = 0, n = 0, p = 0, E = 0, f = 0, s = 0, h = 0, m = 0;
			if (!r) {
				s = -255;
				return s | 0;
			}
		...
		function At(f) {
			f = f | 0;
			var w = 0, S = 0, _ = 0, F = 0, E = 0, u = 0, a = 0, l = 0, i = 0, m = 0, h = 0, x = 0, U = 0, T = 0, g = 0, z = 0, I = 0, D = 0, B = 0, R = 0, y = 0, L = 0, M = 0, H = 0, A = 0, v = 0, b = 0, O = 0, o = 0, P = 0, C = 0;
			C = t;
			t = t + 16 | 0;
			R = C;
			O = f + 288 | 0;
			...
			if (!i) {
				...
				do
					if ((a | 0) != -1) {
						i = (a | 0) < 3971 ? 8000 : (a | 0) < 4511 ? 11025 : (a | 0) < 5421 ? 12000 : (a | 0) < 7231 ? 16000 : (a | 0) < 9971 ? 22050 : (a | 0) < 11221 ? 24000 : (a | 0) < 15251 ? 32000 : (a | 0) < 15961 ? 44100 : i;
						if ((i | 0) > (u | 0))
							if ((u | 0) <= 44100)
								if ((u | 0) <= 32000)
									if ((u | 0) > 24000)
			...
			do
				if ((i | 0) == 4 | (i | 0) == 1) {
					...
					if ((i | 0) == 3) {
						...
						break;
					_ = +(s(m << 4, e[v >> 2] | 0) | 0);
					r[f + 100 >> 2] = _ / (+(e[f + 96 >> 2] | 0) * 1000);
				}
			while (0);
			if ((A | 0) == 98) {
				_ = +(s(m << 4, e[v >> 2] | 0) | 0);
				r[f + 100 >> 2] = _ / (+(e[f + 168 >> 2] | 0) * 1000);
			}
			y = f + 36 | 0;
			i = f + 60 | 0;
			if (e[y >> 2] | 0) {
			...
			while (0);
			St(o);
			a = ((e[P >> 2] | 0) * 3 | 0) + (e[i >> 2] | 0) + ((e[D >> 2] | 0) < 16000 ? 6 : 0) | 0;
			...
			e[S >> 2] = 0;
			if (!(e[T >> 2] | 0)) {
				b = s(((e[P >> 2] | 0) * 72000 | 0) + 72000 | 0, e[m >> 2] | 0) | 0;
				b = (b | 0) % (e[D >> 2] | 0) | 0;
				e[w >> 2] = b;
				e[S >> 2] = b;
			}
		...
		function kt(l, d, u) {
			...
			d = d | 0;
			u = u | 0;
			var a = 0, o = 0, r = 0, w = 0, _ = 0, v = 0, b = 0, f = 0, p = 0, i = 0, h = 0, m = 0, n = 0, s = 0, E = 0, S = 0;
			s = t;
			t = t + 4608 | 0;
			h = s;
			if (!l) {
		...
		function Qe(r, a, u, l, p, S, g, w, D) {
			...
			w = w | 0;
			D = +D;
			var o = 0, i = 0, h = 0, N = 0, m = 0, d = 0, B = 0, A = 0, C = 0, L = 0, F = 0, E = 0, b = 0, f = 0, P = 0, R = 0, T = 0, v = 0, O = 0, y = 0, n = 0, c = 0;
			c = t;
			t = t + 32 | 0;
			N = c;
			v = c + 24 | 0;
		...
		function mt(i) {
			...
			if (!(e[i + 132 >> 2] | 0))
				return;
			t = +r[i + 85684 >> 2];
			n = ~~+hi(+(+Mr(t * 0.00003051850947599719) * 200));
			e[i + 85692 >> 2] = n;
			if ((n | 0) > 0) {
		...
		function Ze(i, n, t, u, p, s, l) {
			...
			s = s | 0;
			l = +l;
			var w = 0, c = 0, d = 0, h = 0, m = 0, o = 0, a = 0;
			w = e[i + 52152 >> 2] | 0;
			d = e[i + 52156 >> 2] | 0;
			h = +r[i + 264 >> 2] * l;
			m = +r[i + 268 >> 2] * l;
		...
		function Ge(s, i, J) {
			...
			i = i | 0;
			J = J | 0;
			var u = 0, o = 0, a = 0, n = 0, O = 0, ee = 0, re = 0, F = 0, c = 0, h = 0, P = 0, b = 0, G = 0, K = 0, z = 0, H = 0, x = 0, X = 0, $ = 0, U = 0, C = 0, Q = 0, Z = 0, L = 0, B = 0, W = 0, j = 0, V = 0, q = 0, I = 0, Y = 0, f = 0, w = 0, D = 0, k = 0, M = 0, N = 0, T = 0, A = 0, R = 0, p = 0, m = 0, _ = 0, S = 0, d = 0, v = 0, g = 0, E = 0, y = 0;
			D = t;
			t = t + 80 | 0;
			w = D;
			G = s + 72 | 0;
			...
			while (1) {
				if ((e[B >> 2] | 0) > 0) {
							...
							do
								if (!(a < 1e-12)) {
									...
									if ((O | 0) == 2) {
										...
										m = +r[C >> 2] + m * 0.5;
										a = E * 0.6427876353263855 + S * 0.9848077297210693 + g * 0.3420201539993286 + _;
										y = v * 0.7660444378852844 + d * 0.1736481785774231 + p * 0.9396926164627075 + m;
										r[c + 4 >> 2] = a + y;
										r[c + 8 >> 2] = a - y;
										y = S * 0.6427876353263855 - E * 0.3420201539993286 + g * 0.9848077297210693 - _;
										a = d * 0.7660444378852844 - v * 0.9396926164627075 - p * 0.1736481785774231 + m;
										r[c + 36 >> 2] = y + a;
										r[c + 40 >> 2] = y - a;
										_ = E * 0.9848077297210693 + S * 0.3420201539993286 - g * 0.6427876353263855 - _;
										m = d * 0.9396926164627075 - v * 0.1736481785774231 + p * 0.7660444378852844 - m;
										r[c + 52 >> 2] = m + _;
										r[c + 56 >> 2] = _ - m;
										m = +r[K >> 2] - +r[w >> 2];
										_ = +r[X >> 2] - +r[x >> 2];
										...
										d = +r[L >> 2] - d * 0.5;
										E = v * 0.9396926164627075 - g * 0.1736481785774231 - S * 0.7660444378852844 - d;
										y = _ * 0.9848077297210693 + m * 0.3420201539993286 + p * 0.6427876353263855 + a;
										r[c + 12 >> 2] = E + y;
										r[c + 16 >> 2] = E - y;
										y = v * 0.7660444378852844 - g * 0.9396926164627075 + S * 0.1736481785774231 + d;
										E = m * 0.6427876353263855 - _ * 0.3420201539993286 - p * 0.9848077297210693 + a;
										r[c + 28 >> 2] = y + E;
										r[c + 32 >> 2] = y - E;
										d = g * 0.7660444378852844 + v * 0.1736481785774231 - S * 0.9396926164627075 + d;
										a = _ * 0.6427876353263855 + m * 0.9848077297210693 - p * 0.3420201539993286 - a;
										r[c + 60 >> 2] = d + a;
										r[c + 64 >> 2] = d - a;
										break;
									}
					...
					if ((i | 0) == 1)
						l(s + 27824 + (f * 4608 | 0) | 0, s + 27824 + (f * 4608 | 0) + 2304 | 0, 2304) | 0;
				}
				f = f + 1 | 0;
				if ((f | 0) >= (e[G >> 2] | 0))
					break;
		...
		function Ke(s, n) {
			s = s | 0;
			n = n | 0;
			var h = 0, g = 0, d = 0, p = 0, F = 0, v = 0, a = 0, b = 0, f = 0, S = 0, e = 0, u = 0, i = 0, t = 0, k = 0, c = 0, _ = 0, l = 0, w = 0, o = 0, m = 0, y = 0, G = 0, W = 0, V = 0, Z = 0, z = 0, X = 0, N = 0, D = 0, P = 0, M = 0, C = 0, B = 0, R = 0, x = 0, T = 0, K = 0, A = 0, q = 0, O = 0, j = 0, I = 0, Y = 0, H = 0, L = 0, U = 0, J = 0, Q = 0, $ = 0, ee = 0, re = 0, E = 0;
			h = s;
			g = -15;
			d = 7952;
			p = s + -248 | 0;
		...
		function A(i, n, y) {
			...
			n = n | 0;
			y = y | 0;
			var t = 0, b = 0, k = 0, _ = 0, g = 0, a = 0, F = 0, M = 0, h = 0, u = 0, d = 0, c = 0, l = 0, f = 0, m = 0, o = 0, w = 0, v = 0, E = 0, p = 0, s = 0, S = 0;
			m = De(i) | 0;
			if ((m | 0) == 1 | (m | 0) == 4)
				t = 9808;
			else
		...
		function Q(r, d, m, s, u, f, a, _) {
			...
			a = a | 0;
			_ = _ | 0;
			var n = 0, o = 0, i = 0, c = 0, h = 0, S = 0, w = 0, b = 0, k = 0, p = 0, v = 0, E = 0;
			E = t;
			t = t + 720 | 0;
			v = E + 456 | 0;
			p = E + 228 | 0;
		...
		function Or(i) {
			...
			i = +ji(u + u * i * (i * (i * (i * (i * 0.0013333559164630223 + 0.009618129842126066) + 0.0555041086648214) + 0.2402265069591) + 0.6931471805599453), (o & -256 | 0) / 256 | 0);
			t = s;
			return +i;
		}
		function Fr(r, i) {
		...
		function Mr(r) {
			r = +r;
			var i = 0, s = 0, a = 0, c = 0, t = 0, l = 0, u = 0, o = 0;
			f[n >> 3] = r;
			s = e[n >> 2] | 0;
			i = e[n + 4 >> 2] | 0;
			a = (i | 0) < 0;
			...
			e[n + 4 >> 2] = a;
			c = +f[n >> 3];
			r = l * (r + (t * (t * (t * 0.15313837699209373 + 0.22222198432149784) + 0.3999999999940942) + u * (t * (t * (t * 0.14798198605116586 + 0.1818357216161805) + 0.2857142874366239) + 0.6666666666666735))) + (o - c - r);
			o = c * 0.4342944818781689;
			t = +(s + (i >>> 20) | 0);
			u = t * 0.30102999566361177;
			l = u + o;
			r = l + (o + (u - l) + (r * 0.4342944818781689 + (t * 3.694239077158931e-13 + (c + r) * 2.5082946711645275e-11)));
			return +r;
		}
		function ji(i, t) {
			i = +i;
		...
		function Li(r, s, o) {
			...
			s = s | 0;
			o = o | 0;
			var i = 0, l = 0, c = 0, m = 0, w = 0, d = 0, f = 0, n = 0, h = 0, u = 0, a = 0;
			a = t;
			t = t + 224 | 0;
			f = a + 120 | 0;
			u = a + 80 | 0;
		...
		function qe(y, r, O, Ae, _e) {
			...
			Ae = Ae | 0;
			_e = _e | 0;
			var Re = 0, le = 0, D = 0, u = 0, d = 0, l = 0, F = 0, a = 0, w = 0, G = 0, W = 0, p = 0, v = 0, X = 0, A = 0, L = 0, H = 0, oe = 0, P = 0, B = 0, N = 0, b = 0, j = 0, me = 0, J = 0, Z = 0, x = 0, I = 0, k = 0, we = 0, ee = 0, he = 0, Q = 0, fe = 0, de = 0, He = 0, ze = 0, Ue = 0, ce = 0, $e = 0, er = 0, C = 0, ie = 0, ve = 0, Fe = 0, qe = 0, re = 0, Se = 0, Me = 0, Be = 0, ge = 0, tr = 0, Ee = 0, Te = 0, lr = 0, cr = 0, Ke = 0, ye = 0, Qe = 0, ir = 0, Ze = 0, dr = 0, ur = 0, $ = 0, nr = 0, je = 0, K = 0, _ = 0, Ve = 0, E = 0, sr = 0, ne = 0, ue = 0, Ie = 0, hr = 0, or = 0, ke = 0, De = 0, pe = 0, Oe = 0, rr = 0, q = 0, fr = 0, U = 0, xe = 0, ar = 0, Je = 0, Ye = 0, Xe = 0, M = 0, Pe = 0, ae = 0, Ce = 0, T = 0, g = 0, We = 0, Ge = 0, Y = 0, z = 0;
			z = t;
			t = t + 864 | 0;
			rr = z + 16 | 0;
			U = z + 8 | 0;
													...
													do
														if (u >>> 0 >= a >>> 0) {
															...
															do {
																...
																r = m;
																P = te(N | 0, r | 0, 1000000000, 0) | 0;
																e[u >> 2] = P;
																r = se(N | 0, r | 0, 1000000000, 0) | 0;
																u = u + -4 | 0;
															} while (u >>> 0 >= a >>> 0);
															if (!r)
																break;
		...
		function W(n) {
			n = n | 0;
			var d = 0, l = 0, c = 0, s = 0, o = 0, r = 0, i = 0, f = 0, p = 0, S = 0, b = 0, m = 0, v = 0, w = 0, u = 0, I = 0, y = 0, M = 0, k = 0, _ = 0, t = 0, h = 0, A = 0, E = 0, D = 0, L = 0, x = 0, U = 0, H = 0, z = 0, P = 0, N = 0, T = 0, F = 0, g = 0, C = 0, R = 0, O = 0;
			do
				if (n >>> 0 < 245) {
					u = n >>> 0 < 11 ? 16 : n + 11 & -8;
					n = u >>> 3;
				...
				e:
					do
						if (m) {
							...
							while (1) {
								r = e[o >> 2] | 0;
								if (r >>> 0 <= m >>> 0 ? (i = e[o + 4 >> 2] | 0, s = r + i | 0, s >>> 0 > m >>> 0) : 0)
									break;
								o = e[o + 8 >> 2] | 0;
							}
							f = r + (i + -39) | 0;
		...
		function _(l) {
			l = l | 0;
			var s = 0, t = 0, n = 0, i = 0, r = 0, m = 0, w = 0, c = 0, u = 0, f = 0, p = 0, S = 0, d = 0, h = 0, _ = 0, b = 0, v = 0, E = 0, o = 0;
			if (!l)
				return;
			r = l + -8 | 0;
			m = e[24126] | 0;
		...
		function Me(f, c, d, w, n) {
			...
			w = w | 0;
			n = n | 0;
			var u = 0, t = 0, a = 0, l = 0, o = 0, i = 0, r = 0, s = 0, p = 0, h = 0;
			s = f;
			i = c;
			r = i;
			o = d;
	...
	var i64Math = function () {
		...
		function k(t) {
			...
			var s = (1 << e) - 1, n, o = false, a = '', i = this.t;
		...
		function T(o, r) {
			...
			var a = this.DB - t;
			var s = (1 << a) - 1;
			var i = Math.floor(o / this.DB), n = this.s << t & this.DM, e;
			for (e = this.t - 1; e >= 0; --e) {
				r[e + i + 1] = this[e] >> a | n;
				n = (this[e] & s) << t;
			}
		...
		function _(t, i) {
			var r = 0, e = 0, n = Math.min(t.t, this.t);
			while (r < n) {
				e += this[r] - t[r];
				i[r++] = e & this.DM;
				e >>= this.DB;
		...
		function C(_, a, e) {
			...
			var E = this.FV / w, v = (1 << this.F1) / w, S = 1 << this.F2;
			var f = e.t, u = f - n, o = a == null ? t() : a;
			i.dlShiftTo(u, o);
			if (e.compareTo(o) >= 0) {
				e[e.t++] = 1;
				e.subTo(o, e);
		...
		function J(i, n) {
			if (i > 4294967295 || i < 1)
				return r.ONE;
			var e = t(), o = t(), a = n.convert(this), s = d(i) - 1;
			a.copyTo(e);
			while (--s >= 0) {
				n.sqrTo(e, o);
				if ((i & 1 << s) > 0)
		...
		function $(o, e) {
			...
			var l = Math.pow(e, a), s = false, t = 0, i = 0;
			for (var n = 0; n < o.length; ++n) {
				var f = h(o, n);
				if (f < 0) {
	...
	run();
	var NUM_CH = 2, HEAPU8 = Module.HEAPU8, malloc = Module._malloc, free = Module._free, lame_init = Module._lame_init, lame_set_mode = Module._lame_set_mode, lame_set_num_channels = Module._lame_set_num_channels, lame_set_in_samplerate = Module._lame_set_in_samplerate, lame_set_brate = Module._lame_set_brate, lame_init_params = Module._lame_init_params, lame_encode_buffer_ieee_float = Module._lame_encode_buffer_ieee_float, lame_encode_flush = Module._lame_encode_flush, lame_close = Module._lame_close;
...
var NUM_CH = 2, sampleRate = 44100, options = undefined, maxBuffers = undefined, encoder = undefined, recBuffers = undefined, bufferCount = 0;
function error(e) {
	self.postMessage({
		command: 'error',
		message: 'mp3: ' + e
